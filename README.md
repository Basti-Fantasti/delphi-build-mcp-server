...
Generate `delphi_config.toml` from multiple IDE build logs for different configurations and platforms. Creates a hierarchical config with platform and config-specific settings.
...
- `statistics`: Configs found, platforms found, total library paths
